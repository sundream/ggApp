...
--	}
--example:
--	curl -v 'http://127.0.0.1:8887/api/account/server/add?sign=debug&appid=appid&serverid=gamesrv_1&server=server_json_data'
--	curl -v 'http://127.0.0.1:8887/api/account/server/add' -d 'sign=debug&appid=appid&serverid=gamesrv_1&server=server_json_data'
