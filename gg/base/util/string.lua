...
--- 根据26个字母和0-9数字随机出指定长度字符串
--@param[type=int] len 长度
--@return[type=string] 随机串
...
--- 检测字符串是否有前缀
--@param[type=string] s 字符串
--@param[type=string] prefix 前缀
--@param[type=int,opt] from 开始位置
--@param[type=int,opt] to 结束位置(包括这个位置),即范围为s[from:end]
