...
--- 以指定元素重复若干次生成一个列表
--@param[type=any] elem 元素
--@param[type=int] count 重复次数
--@return[type=table] 列表
...
--- 根据指定范围[from,to]生成整数列表
--@param[type=int] from 起始值
--@param[type=int] to 终止值
--@return[type=table] 整数列表
